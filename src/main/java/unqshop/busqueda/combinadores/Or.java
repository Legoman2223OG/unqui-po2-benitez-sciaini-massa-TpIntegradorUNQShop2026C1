...
/**
 * Una clase que representa un combinador de criterios OR para la busqueda de items del catalogo.
 *
 ...
 * @see ItemCatalogo
 */
public class Or implements CriterioCatalogo {

	private CriterioCatalogo criterio1;
	private CriterioCatalogo criterio2;
	
	/**
	 * Crea una instancia del criterio para combinar dos criterios que deben ser evaluados en sentido lógico OR.
	 * 
	 * @param El primer criterio en CriterioCatalogo.
	 * @param El segundo criterio en CriterioCatalogo.
	 */
	public Or(CriterioCatalogo criterio1, CriterioCatalogo criterio2) {
